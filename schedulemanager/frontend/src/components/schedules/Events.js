    ...
    return (
      <thead>
        <tr>
          ...
          <th className = "noselect">Recurring</th>
          <th className = "noselect">Active For Day Generation</th>
        </tr>
      </thead>
    );
  }
...
export class Events extends Component {
  ...
  render() {
    ...
    const rowStyle = (rowId) => rowId === this.state.selectedEventId ?
      {
    ...
    return (
      <div className="d-flex flex-column flex-wrap">
        <table className="table table-striped">
          <ChooseTableHead numEvents={this.props.eventdefinitions.length} />
          <tbody>
              ...
              <tr key={eventdefinition.event_name + eventdefinition.event_id} id = {"tr" + eventdefinition.event_id} className = "noselect" style = {rowStyle(eventdefinition.event_id)} onClick = { this.handleClick }>
                ...
                <td>
                  <div className = "custom-control custom-checkbox tdDiv noselect">
                    <input type="checkbox" className = "custom-control-input" id = {"customCheck" + eventdefinition.event_id} readOnly checked = {eventdefinition.recurring} />
                    <label className = "custom-control-label" htmlFor = {"customCheck" + eventdefinition.event_id}></label>
                  </div>
                </td>
                <td>
