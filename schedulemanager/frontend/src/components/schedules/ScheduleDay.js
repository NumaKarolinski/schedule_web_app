    ...
    render() {
        ...
        validTimeDeltaDisplay && (sortedTimedeltas.length > 0) ? (
            <div style = { smallerMedia ? ({ paddingBottom: "22px" }) : (smallMedia ? { paddingBottom: "10px" } : null) } className = "d-flex flex-row flex-wrap justify-content-around">
                <button id = "regenerateDay" onClick = { this.handleClick } className = {"btn btn-primary btn-sm m-1 noselect" + (this.props.loadingTimeDeltas || (this.props.timeDeltasUpdated && (this.props.timedeltas.length > 0)) ? " invisibleButton" : "")}>Regenerate Day</button>
        ...
        (
            <div style = { smallerMedia ? ({ paddingBottom: "22px" }) : (smallMedia ? { paddingBottom: "10px" } : null) } className = "d-flex justify-content-center">
                <button id = "generateDay" onClick = { this.handleClick } className = {"btn btn-primary btn-sm m-1" + (this.props.loadingTimeDeltas || (this.props.timeDeltasUpdated && (this.props.timedeltas.length > 0)) ? " invisibleButton" : "")}>Generate Day</button>
            </div>  
        );
